...
?>
 <div class="row mt">
  <table width="70%" align="center">
    <tr>
      <td ><img src="img/profil/<?php echo $data['foto']?>" height="200" width="100%"></td>
    </tr>
  </table>
  <div class="col md-10">
            ...
            <div class="row content-panel">
              <div class="panel-heading">
                <ul class="nav nav-tabs nav-justified">
                  ...
                  <li>
                    <a data-toggle="tab" href="#edit"><b>Produk</b></a>
                  </li>
                </ul>
              </div>
              <!-- /panel-heading -->
                  ...
                  <div id="kontak" class="tab-pane active">
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                       <a href="proses_batal_banned_penjual.php?id=<?php echo $id;?>" class="btn btn-success"><i class="fa fa-check"></i> Aktifkan Akun</a>
