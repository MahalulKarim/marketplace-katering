    ...
    <div class="col-lg-12 mt">
            ...
            <div class="row content-panel">
              ...
              <div class="col-md-4 profile-text">
                ...
                <br>
                 <a href="proses_batal_banned_pembeli.php?id=<?php echo $id;?>" class="btn btn-success"><i class="fa fa-check"></i> Batal Banned Akun</a>
              </div>
              <!-- /col-md-4 -->
            ...
            <!-- /row -->
                      ...
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <div class="col-md-8 col-md-offset-2 mt">
                          ...
                          ?>
                          <p>
                            Status : <?php echo $data['status']?> <i class="fa fa-exclamation"> </i>
                          </p>
                          <p>
