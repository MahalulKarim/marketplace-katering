<?php include 'headerfooter/atas.php'?>
       <h3><i class="fa fa-user"></i> Data Penjual</h3>
       <hr style="border: 1px solid #417e9d;">
        ...
        <tbody>
          <?php 
          include 'koneksi.php';
         $query="SELECT * FROM `user` where status='aktif' AND type_user='penjual'";
            ...
            <tr>
              ...
              <td align="center">
                ...
                <a href="#" type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal<?php echo $data['id_user']; ?>"><i class="fa fa-info"></i></a>
                 <a href="hapus.php?id_user=<?php echo $data['id_user']?>" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data?')"><i class="fa fa-trash"></i></a>
                </div>
              </td>
            </tr>
                     ...
                     <div class="row">
                       ...
                       <div class="col-md-3 ml-auto">
                        ...
                        <div class="modal-footer">
                          <a href="profil_toko.php?id=<?php echo $data1['id_user']?>" class="btn btn-success">Lihat Profil</a>
