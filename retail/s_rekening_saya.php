             ...
             if(empty($nama)||empty($norek)){
                ...
                if (mysqli_num_rows($result2)<1) {
                    ...
                    $nama_bank=$data2['nama_bank'];
                     ...
                     $query = "INSERT INTO `bank` SET id_user='$id_user',kode_bank='$kode_bank',nama_bank='$nama_bank',nama='$nama',no_rek='$norek'";
                            $result = mysqli_query($db, $query); 
                            if ($result) {
                                 echo "<script type='text/javascript'>
                                        alert('Nomor Rekening Berhasil ditambah!');window.location='d_rekening_saya.php'</script>
                                        ";
                            }else { 
