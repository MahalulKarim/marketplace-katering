                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">                        
                                                                  ...
                                                                  <div class="col-md-6">
                                                                     ...
                                                                     <?php
                                                                     $que="SELECT * FROM menu WHERE id_menu='$id'";
                                                                     $res=mysqli_query($db,$que);
                                                                     $da=mysqli_fetch_array($res);
                                                              if ($da['status']=='kosong') {
                                                                echo "<p class='text-danger'>Menu saat ini tidak tersedia!</p>";
                                                              }else{
                                                              ?>
                                        ...
                                        <div class="modal-dialog modal-dialog modal-dialog-scrollable">
                                          <div class="modal-content">
                                            <div class="modal-header bg-warning" style="height: 60px">
                                                 <p>  <img src="../asset/user/user/foto/<?php echo $data1['foto']; ?>" class="img-circle bordered "  alt="..." width="40" height="40"> <?php 

                                                 echo $data1['nama_katering']; ?>
                            ...
                            <!-- ====================== -->
                                     ...
                                     <div class="col-md-3">
                                        ...
                                        <div class="modal-dialog modal-dialog modal-dialog-scrollable">
                                          <div class="modal-content">
                                            <div class="modal-header bg-warning" style="height: 60px">
                                                 <p>  <img src="../asset/user/gambar/pembeli/foto/<?php echo $hasil['foto']; ?>" class="img-circle bordered "  alt="..." width="40" height="40"> <?php echo $hasil['nama']; ?></p>
                                              <p class="modal-title"></p>
