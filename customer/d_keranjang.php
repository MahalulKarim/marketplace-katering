...
<div class="container-fluid pt-2 mb-6">
        ...
        <?php
                            ...
                            $query = "SELECT pr.id_menu,pr.nama_menu,pr.harga,pr.gambar,pr.deskripsi,c.*, j.* FROM chart c, menu pr, jenis j 
                            WHERE pr.id_menu=c.id_menu AND j.id_jenis=pr.id_jenis AND c.id_user='$iduser' AND c.status='0'";
