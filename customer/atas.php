        ...
        <div class="col-auto">
         ...
         <ul class="nav justify-content-end mr-4"> 
             <li class="nav-item dropdown mr-4">
              <a class="btn btn-outline-danger btn-sm dropdown" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-user"></i>
              </a>    
              <ul class="dropdown-menu dropdown-left" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="chat.php">Pesan</a></li>
