...
if (mysqli_num_rows($cari) < 1) {
  ...
  if(isset($_GET['id'])){
    $id=$_GET['id'];$query = "SELECT * FROM menu WHERE id_menu='$id'";
                    ...
                    <div class="row g-3">
                     ...
                     <div class="row g-3">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            <label for="inputEmail4" class="form-label">Tanggal Pemesanan :</label>
...
</body> <script src="../asset/user/js/jquery.js"></script>
<script>
function sum() {
