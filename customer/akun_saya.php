...
<div class="container-fluid pt-2 mb-6">
        ...
        <img src="../asset/user/gambar/user/foto/<?php echo $hasil['foto']; ?>" class="img-circle"  alt="..." width="100" height="100"></h2>
      <h4 class="text-center"><?php echo $hasil['nama'] ?></h4>
<p class="text-center"></p>
      ...
      <p class="text-center">
        <a href="" data-target="#alih<?php echo $hasil['id_user']; ?>" data-toggle="modal" class="btn btn-primary btn-sm">Buka Catering</a>
      </p>
                  ...
                  <div class="col-md-12 d-flex justify-content-center">
                    <form method="POST" action="s_e_foto_profil.php" enctype="multipart/form-data">
                        ...
                        <div class="card " style="width: 10rem;">
                            <div class="imgWrap">
                                <img src="../asset/user/gambar/user/foto/<?php echo $hasil['foto']; ?>" id="imgView" class="card-img-top img-fluid">
                            </div>
                        </div>
                        <br>
...
<div class="modal" tabindex="-1" id="alih<?php echo $hasil['id_user'];?>">
            <div class="modal-dialog md-8">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Beralih Akun Ke Penjual</h5>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
              <div class="modal-body">
                <div class="row">
                <!-- MENAMPILKAN FORM EDIT USRER -->
                  <div class="col-md-12 d-flex justify-content-center">
                    <form method="POST" action="s_e_profil.php" enctype="multipart/form-data">
                        <input type="hidden" class="form-control form-control-sm" name="id_user" value="<?php echo $hasil['id_user'];?>">
  
                      <label class="form-label"></label>
                      <input type="text" class="form-control form-control-sm" name="nama_katering" placeholder="nama katering" required>
                        <br>
              ...
              <div class="modal-footer">
                  <button type="submit" class="btn btn-primary btn-sm" name="alih">Beralih</button>
                   </form>
                 <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Close</button>
              </div>
              </div>
