...
<?php
	...
	$query="SELECT c.*,p.id_menu,p.nama_menu,u.id_user FROM chatroom c,menu p,chat2 ch,user u WHERE u.id_user=ch.id_user2 AND p.id_menu=ch.id_menu AND ch.id_chat=c.id_chat AND c.id_user='$id_user' AND c.type='1' GROUP BY c.id_chat";
				      ...
				      <div class="modal-footer">
				      	<div class="col-md-12 p-2">
				      		 <form method="POST" action="kirim_pesan.php">
				      		 	...
				      		 	<input type="hidden" name="id_user2" value="<?php echo $data['id_user']?>">
