...
<head>
  ...
  <title>CS Page Catering Marketplace</title>
...
<body>
  <section id="container">
    ...
    <header class="header bg-theme05">
      ...
      <!--logo start-->
      <a href="index_admin.php" class="logo"><b>CsPage<span></span></b></a>
      <!--logo end-->
       <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="web/indexweb.php">Lihat Situs</a></li>
        </ul>
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt">
            <a class="active" href="index_cs.php">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="respon_penjual.php">Penjual</a></li>
              <li><a href="respon_pembeli.php">Pembeli</a></li>
            </ul>
          </li>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span>Topik Pertanyaan</span>
            </a>
               <ul class="sub">
              <li><a href="data_topik_penjual.php">Penjual</a></li>
